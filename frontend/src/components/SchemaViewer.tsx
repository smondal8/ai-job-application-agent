...
export const SchemaViewer: React.FC = () => {
  ...
  > = {
    ...
    application_approvals: {
      description: 'Cryptographic human approval gate records, immutable input hashes, and preparation authorization tokens.',
      phase: 'Phase 8 Active',
      columns: [
        { name: 'id', type: 'Integer', constraints: 'PK, Autoincrement', description: 'Unique approval record ID' },
        { name: 'application_id', type: 'Integer', constraints: 'FK -> applications.id (CASCADE), Indexed', description: 'Target application' },
        { name: 'status', type: 'String(50)', constraints: 'NOT NULL, Default: approved, Indexed', description: 'approved, revoked, invalidated' },
        { name: 'job_id', type: 'Integer', constraints: 'FK -> jobs.id (CASCADE), Indexed', description: 'Job listing linked at sign-off' },
        { name: 'approved_job_hash', type: 'String(64)', constraints: 'NOT NULL', description: 'SHA-256 hash of job title, company & JD' },
        { name: 'candidate_profile_id', type: 'Integer', constraints: 'FK -> candidate_profiles.id (SET NULL)', description: 'Candidate profile at sign-off' },
        { name: 'approved_candidate_hash', type: 'String(64)', constraints: 'NOT NULL', description: 'SHA-256 hash of candidate verified facts' },
        { name: 'tailored_resume_id', type: 'Integer', constraints: 'FK -> tailored_resumes.id (SET NULL)', description: 'Tailored resume at sign-off' },
        { name: 'approved_resume_hash', type: 'String(64)', constraints: 'NOT NULL', description: 'SHA-256 hash of compiled markdown & highlights' },
        { name: 'approved_answers_hash', type: 'String(64)', constraints: 'NOT NULL', description: 'SHA-256 hash of screening Q&A payload' },
        { name: 'approval_token', type: 'String(128)', constraints: 'NOT NULL, Unique, Indexed', description: 'Cryptographic authorization token' },
        { name: 'approver_id', type: 'String(100)', constraints: 'NOT NULL, Default: human_user', description: 'User or reviewer ID' },
        { name: 'approver_notes', type: 'Text', constraints: 'Nullable', description: 'Sign-off justification notes' },
        { name: 'is_valid', type: 'Boolean', constraints: 'NOT NULL, Default: True, Indexed', description: 'Live validity flag' },
        { name: 'invalidation_reason', type: 'Text', constraints: 'Nullable', description: 'Reason if invalidated due to material changes' },
        { name: 'approved_at', type: 'DateTime', constraints: 'NOT NULL (UTC)', description: 'Approval grant timestamp' },
        { name: 'created_at', type: 'DateTime', constraints: 'NOT NULL (UTC)', description: 'Created timestamp' },
      ],
    },
    applications: {
      description: 'Central Application entity linking a target job, candidate profile, and selected tailored resume variant.',
      phase: 'Phase 7 Active',
      columns: [
        { name: 'id', type: 'Integer', constraints: 'PK, Autoincrement', description: 'Unique application ID' },
        { name: 'job_id', type: 'Integer', constraints: 'FK -> jobs.id (CASCADE), Indexed', description: 'Target job position' },
        { name: 'tailored_resume_id', type: 'Integer', constraints: 'FK -> tailored_resumes.id (SET NULL), Indexed', description: 'Selected tailored resume version' },
        { name: 'candidate_profile_id', type: 'Integer', constraints: 'FK -> candidate_profiles.id (SET NULL), Indexed', description: 'Source candidate profile' },
        { name: 'status', type: 'String(50)', constraints: 'NOT NULL, Default: draft, Indexed', description: 'draft, ready_for_review, in_review, approved, staged_for_preparation, requires_reapproval, rejected, submitted, archived' },
        { name: 'approval_token', type: 'String(128)', constraints: 'Nullable, Indexed', description: 'Active approval token' },
        { name: 'approved_at', type: 'DateTime', constraints: 'Nullable', description: 'Approved timestamp' },
        { name: 'invalidation_reason', type: 'Text', constraints: 'Nullable', description: 'Reason for invalidation' },
        { name: 'portal_type', type: 'String(100)', constraints: 'NOT NULL, Default: generic', description: 'greenhouse, lever, workday, ashby, generic' },
        { name: 'portal_url', type: 'String(1024)', constraints: 'Nullable', description: 'Direct application link' },
        { name: 'cover_letter', type: 'Text', constraints: 'Nullable', description: 'Application cover letter' },
        { name: 'answers_payload', type: 'JSON', constraints: 'Default: {}', description: 'Screening questions and form responses' },
        { name: 'submission_notes', type: 'Text', constraints: 'Nullable', description: 'Candidate/user submission notes' },
        { name: 'reviewer_notes', type: 'Text', constraints: 'Nullable', description: 'Human reviewer staging notes' },
        { name: 'applied_at', type: 'DateTime', constraints: 'Nullable', description: 'Application submission timestamp' },
        { name: 'created_at', type: 'DateTime', constraints: 'NOT NULL (UTC)', description: 'Created timestamp' },
      ],
    },
    job_discovery_runs: {
    ...
    browser_preparation_runs: {
      description: 'Audit log and execution results for Playwright browser application preparation runs.',
      phase: 'Phase 9',
      columns: [
        { name: 'id', type: 'Integer', constraints: 'PK, Autoincrement', description: 'Unique preparation run identifier' },
        { name: 'application_id', type: 'Integer', constraints: 'FK -> applications.id', description: 'Associated job application' },
        { name: 'job_id', type: 'Integer', constraints: 'FK -> jobs.id', description: 'Associated job listing' },
        { name: 'approval_id', type: 'Integer', constraints: 'FK -> application_approvals.id', description: 'Authorizing approval certificate' },
        { name: 'approval_token', type: 'String(128)', constraints: 'NOT NULL, Indexed', description: 'Cryptographic authorization token' },
        { name: 'portal_type', type: 'String(100)', constraints: 'NOT NULL, Default: generic', description: 'Portal adapter used' },
        { name: 'portal_url', type: 'String(1024)', constraints: 'Nullable', description: 'Target job application URL' },
        { name: 'status', type: 'String(50)', constraints: 'NOT NULL, Indexed', description: 'staged, paused_for_human_input, blocked_by_captcha, blocked_by_auth, failed' },
        { name: 'fields_filled', type: 'JSON', constraints: 'Default: []', description: 'List of filled form elements and mapped values' },
        { name: 'unresolved_fields', type: 'JSON', constraints: 'Default: []', description: 'List of unsupported or ambiguous fields requiring human input' },
        { name: 'resume_uploaded', type: 'Boolean', constraints: 'NOT NULL, Default: 0', description: 'Indicates whether resume file was uploaded' },
        { name: 'screenshot_path', type: 'String(1024)', constraints: 'Nullable', description: 'Disk path to captured staging screenshot artifact' },
        { name: 'final_submit_clicked', type: 'Boolean', constraints: 'NOT NULL, Default: 0', description: 'Strict invariant: ALWAYS 0 (never clicked)' },
        { name: 'guard_triggered', type: 'Boolean', constraints: 'NOT NULL, Default: 0', description: 'True if submit guard halted staging before submit' },
        { name: 'captcha_detected', type: 'Boolean', constraints: 'NOT NULL, Default: 0', description: 'True if CAPTCHA was detected and paused' },
        { name: 'auth_required', type: 'Boolean', constraints: 'NOT NULL, Default: 0', description: 'True if authentication challenge was detected' },
