...
class Application(Base, TimestampMixin):
    """Central Job Application entity linking a single job, candidate profile, and selected tailored resume (Phase 7)."""
    ...
    # Status lifecycle: draft, ready_for_review, in_review, approved_pending_submission, submitted, rejected, archived
